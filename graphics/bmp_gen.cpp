...
#include "bmp_gen.h"
/*
unsigned char* convert_image(unsigned char* image){
// convert ARGB -> BGR
};
*/
...
unsigned char* createBitmapInfoHeader(int height, int width)
{
    ...
    infoHeader[0] = (unsigned char)(40); /// header size
    infoHeader[4] = (unsigned char)(width); /// image width
    infoHeader[5] = (unsigned char)(width >> 8);
    infoHeader[6] = (unsigned char)(width >> 16);
    infoHeader[7] = (unsigned char)(width >> 24);
    infoHeader[8] = (unsigned char)(height); /// image height
    infoHeader[9] = (unsigned char)(height >> 8);
    infoHeader[10] = (unsigned char)(height >> 16);
    infoHeader[11] = (unsigned char)(height >> 24);
    infoHeader[12] = (unsigned char)(1);/// number of color planes
    infoHeader[14] = (unsigned char)(24);/// bits per pixel
